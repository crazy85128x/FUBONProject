...
class Ui_MainWindow2(object):
    def setupUi(self, Ui_MainWindow2):
        ...
        self.main_widget = QtWidgets.QWidget(Ui_MainWindow2)  # 創建窗口主部件
        ...
        self.textEdit.setPlaceholderText("  請輸入要合成的語句，點擊下面的按鈕")
    ...
    def retranslateUi(self, Ui_MainWindow2):
        ...
        self.label.setText(_translate("Ui_MainWindow2", "語音合成"))

        self.label.setAlignment(Qt.AlignCenter)
        Ui_MainWindow2.setWindowOpacity(1) # 設置窗口透明度
        #Ui_MainWindow2.setAttribute(QtCore.Qt.WA_TranslucentBackground) # 設置窗口背景透明
