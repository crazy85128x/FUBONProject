...
class Ui_Dialog2(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton.setText(_translate("Dialog", "  更多訊息  "))
        self.pushButton_16.setText(_translate("Dialog", "  年齡  "))
        self.pushButton_17.setText(_translate("Dialog", "  姓名  "))
        self.pushButton_18.setText(_translate("Dialog", "  性別  "))
        self.pushButton_19.setText(_translate("Dialog", "註冊"))
        self.pushButton_2.setText(_translate("Dialog", " 修改更多訊息 "))
        self.pushButton_20.setText(_translate("Dialog", " 修改年齡 "))
        self.pushButton_22.setText(_translate("Dialog", " 修改性別 "))
        self.pushButton_23.setText(_translate("Dialog", "修改訊息"))
        self.pushButton_3.setText(_translate("Dialog", "查找"))
        self.pushButton_24.setText(_translate("Dialog", "確定"))
        self.pushButton_25.setText(_translate("Dialog", "退出"))

        self.pushButton_6.setFixedSize(30, 30) # 設置關閉按鈕的大小
        self.pushButton_4.setFixedSize(30, 30)  # 設置按鈕大小
        self.pushButton_5.setFixedSize(30, 30) # 設置最小化按鈕大小
        ...
        for lineedit in linetext:
            ...
            i=i+1
            lineedit.setAlignment(Qt.AlignCenter)  #輸入的字放到中間

        self.lineEdit.setPlaceholderText('輸入您想要修改人信息的姓名，點擊查找')
