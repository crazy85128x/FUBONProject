...
class Ui_MainWindow3(object):
    def setupUi(self, Ui_MainWindow3):
        ...
        self.main_widget = QtWidgets.QWidget(Ui_MainWindow3)  # 創建窗口主部件
        ...
        #self.text_label.setPlaceholderText("  輸入要合成的語句，點擊下面的按鈕")
    ...
    def retranslateUi(self, Ui_MainWindow3):
        ...
        self.label.setText(_translate("Ui_MainWindow3", "語音識別"))
        self.text_label.setText("點擊下面的按鈕開始錄製音頻\n再次點擊停止錄音開始識別")
        self.text_label.setAlignment(Qt.AlignCenter)
        self.label.setAlignment(Qt.AlignCenter)
        Ui_MainWindow3.setWindowOpacity(1) # 設置窗口透明度
        #Ui_MainWindow3.setAttribute(QtCore.Qt.WA_TranslucentBackground) # 設置窗口背景透明
        Ui_MainWindow3.setWindowFlag(QtCore.Qt.FramelessWindowHint) # 隱藏邊框
        pe = QPalette()
